...
const services = [
  { ...llm('anthropic', 'Anthropic Claude API', 'https://api.anthropic.com/v1/messages', 'claude-3-5-sonnet-latest', 'anthropic'), auth: 'x-api-key', headers: { 'anthropic-version': '2023-06-01' } }
];
