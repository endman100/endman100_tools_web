...
const services = [
  { ...image('banana2', 'Banana2 Image API', 'https://generativelanguage.googleapis.com/v1beta/models/{model}:generateContent', 'gemini-3-pro-image-preview', 'geminiImage'), auth: 'query-key', summary: 'Banana2 圖像生成 / 編輯功能工具，獨立於 Nano Banana。' }
];
