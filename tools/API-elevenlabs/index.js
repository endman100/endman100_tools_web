...
const services = [
  { ...tts('elevenlabs', 'ElevenLabs API', 'https://api.elevenlabs.io/v1/text-to-speech/{voice}', 'eleven_multilingual_v2', 'elevenTts'), auth: 'xi-api-key', fields: [{ name: 'voice', label: 'Voice ID', type: 'text', value: '21m00Tcm4TlvDq8ikWAM' }, ...ttsFields.filter(f => f.name !== 'voice')] }
];
