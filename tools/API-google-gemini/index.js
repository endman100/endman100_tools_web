...
const services = [
  { ...llm('google-gemini', 'Google Gemini API', 'https://generativelanguage.googleapis.com/v1beta/models/{model}:generateContent', 'gemini-1.5-flash', 'gemini'), auth: 'query-key' }
];
