...
const services = [
  { ...image('google-imagen', 'Google Imagen / Gemini Image', 'https://generativelanguage.googleapis.com/v1beta/models/{model}:predict', 'imagen-3.0-generate-002', 'googleImagen'), auth: 'query-key' }
];
