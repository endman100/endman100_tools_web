...
const services = [
  { ...tts('google-tts', 'Google Cloud Text-to-Speech', 'https://texttospeech.googleapis.com/v1/text:synthesize', 'standard', 'googleTts'), auth: 'query-key', fields: [{ name: 'languageCode', label: 'Language code', type: 'text', value: 'zh-TW' }, { name: 'voice', label: 'Voice name', type: 'text', value: 'zh-TW-Standard-A' }, ...ttsFields.filter(f => !['model','voice'].includes(f.name))] }
];
