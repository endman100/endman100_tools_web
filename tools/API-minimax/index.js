...
const services = [
  { ...llm('minimax', 'MiniMax API', 'https://api.minimax.io/v1/text/chatcompletion_v2', 'MiniMax-Text-01', 'minimaxChat'), extraFields: [{ name: 'groupId', label: 'Group ID（選填）', type: 'text', value: '' }] }
];
