...
const services = [
  { ...image('nano-banana', 'Nano Banana Image API', 'https://generativelanguage.googleapis.com/v1beta/models/{model}:generateContent', 'gemini-2.5-flash-image-preview', 'geminiImage'), auth: 'query-key', summary: 'Google Gemini 影像生成 / 編輯功能工具，與 Banana2 拆成不同 tool。' }
];
