...
const services = [
  { ...tts('playht', 'PlayHT API', 'https://api.play.ht/api/v2/tts/stream', 'PlayDialog', 'playhtTts'), auth: 'playht', credentials: [{ name: 'apiKey', label: 'PlayHT secret key', type: 'password' }, { name: 'userId', label: 'PlayHT user ID', type: 'password' }] }
];
