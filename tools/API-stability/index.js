...
const services = [
  { ...image('stability', 'Stability AI API', 'https://api.stability.ai/v2beta/stable-image/generate/core', 'stable-image-core', 'stabilityCore'), responseType: 'blob', headers: { Accept: 'image/*' } }
];
